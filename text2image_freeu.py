...
def parse_args():
    ...
    # FreeU Config
    parser.add_argument("--seed", type=int, default=2, help="fix random seed to compare with and without FreeU")
    parser.add_argument("--enable_freeu", action='store_true', help="whether enable FreeU")
    parser.add_argument("--b1", type=float, default=1.1, help="parameter of FreeU")
    parser.add_argument("--b2", type=float, default=1.2, help="parameter of FreeU")
    parser.add_argument("--s1", type=float, default=1, help="parameter of FreeU")
    parser.add_argument("--s2", type=float, default=1, help="parameter of FreeU")
